...
export const metadata: Metadata = {
  ...
  description:
    "Find trending fashion, curated collections, and fast shopping from our online store.",
  alternates: {
    canonical: "/",
  },
  openGraph: {
      ...
      <div className="flex px-6 w-full  h-full flex-col">
        <div className="flex  flex-col ">
          ...
          <div className="flex pt-4  max-w-3xl">
            <p className="font-medium hidden sm:block text-center sm:text-start text-[16px] sm:text-[18px]">
              {" "}
              Shop smarter with a platform built for speed, simplicity, and
              trust. Find your favorites, add to cart, and enjoy hassle-free
